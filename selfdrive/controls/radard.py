...
class RadarD:
  ...
  def update(self, sm: messaging.SubMaster, rr: car.RadarData):
    ...
    if len(leads_v3) > 1:
      ...
      #ll, lc, lr, leadCenter, self.radar_state.leadLeft, self.radar_state.leadRight = get_lead_side(
      #  self.v_ego, self.tracks, sm['modelV2'], sm['lateralPlan'].laneWidth, model_v_ego
      # )
