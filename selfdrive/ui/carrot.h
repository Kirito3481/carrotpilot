...
void ui_fill_rect(NVGcontext *vg, const Rect1 &r, const NVGpaint &paint, float radius = 0, float stroke_width = 0, NVGcolor* stroke_color = nullptr);
void ui_fill_rect(NVGcontext *vg, const Rect1 &r, const NVGcolor &color, float radius = 0, float stroke_width = 0, NVGcolor* stroke_color = nullptr);
